				...
				<div>
					<table class="table table-striped table-bordered table-hover">
						...
						<tr>
							...
							<td><span id="wid"></span></td>
						</tr>
						<tr>
							<td><strong>仓库类型：</strong></td>
							<td><span id="wiid"></span></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><pre class="pre-scrollable" style="width:800px;height:60px;"><span id="note">222</span></pre></td>
						</tr>
					</table>
				</div>
				<div>
					<table class="table table-condensed table-bordered table-hover" id="detailsTab">
						...
						<tbody class="text-primary" id="info">
